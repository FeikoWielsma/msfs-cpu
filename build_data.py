...
SPECS = {
    ...
    "Ryzen 7 5700X":    _spec("AM4", "Zen 3", 8, 0, 16, 1, 32, False, 4.6),
    ...
    "Ryzen 7 7700X3D":  _spec("AM5", "Zen 4", 8, 0, 16, 1, 96, True, 4.5),
    ...
    # Memory-config variants (Tom's 5800X3D re-review runs these on DDR4-3200
    # instead of the usual DDR5). Same silicon, so the specs match the base
    # part; they're separate CPU keys purely so the two configs rank apart.
    "Core i7-12700K (DDR4-3200)": _spec("LGA1700", "Alder Lake", 8, 4, 20, 1, 25, False, 5.0),
    ...
    "Core i7-13700K (DDR4-3200)": _spec("LGA1700", "Raptor Lake", 8, 8, 24, 1, 30, False, 5.4),
    ...
    "Core i7-14700K (DDR4-3200)": _spec("LGA1700", "Raptor Lake", 8, 12, 28, 1, 33, False, 5.6),
